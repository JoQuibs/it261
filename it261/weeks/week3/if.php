...
$salary = 95000;
$sales = 148000;
// if sales is equal or less than 999999, then you do not receive any bonus
...
if($sales <= 99999) {
 echo 'Sorry, you did not make your bonus!';
    ...
    $salary *= 1.20;
    echo 'Awesome! You have made 20% bonus! Your annual salary including bonus totals $'.number_format($salary, 2).' dollars';
}