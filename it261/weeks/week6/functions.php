...
We are going to use indexed arrays.</h2>';
...
echo '<h2>The Implide Function</h2>';
$cars = array('bmw', 'chev', 'ford', 'acura', 'dodge', 'volvo');
$my_cars =  implode(', ', $cars);
echo $my_cars;

echo '<h2>Logic behind the wines on our Form</h2>
<p>If post wines are not empty, take post wines and implode them,
then create a new variable named $my_wines</p>
';